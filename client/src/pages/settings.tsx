...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select"; // Added for Currency dropdown
          ...
          <CardContent className="space-y-6">
            <div className="flex items-center gap-6">
              <Avatar className="w-20 h-20 border-2 border-primary/20">
                <AvatarImage src={getAvatarUrl(profileData)} /> 
                <AvatarFallback>
        ...
        <Card className="bg-card border-border/50">
            ...
            <CardContent className="space-y-6">
                ...
                <Button 
                    ...
                    disabled={updateGoalMutation.isPending || !targetValue}
                >
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 border border-red-900/30 rounded-lg bg-red-900/10">
              ...
              <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
                <DialogTrigger asChild>
                  <Button variant="destructive" className="bg-red-600 hover:bg-red-700 font-bold" disabled={deleteAccountMutation.isPending}>Delete</Button>
                </DialogTrigger>
                <DialogContent className="bg-card border-border text-white">
                  <DialogHeader>
